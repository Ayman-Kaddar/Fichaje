    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link @if (strpos(Route::currentRouteAction(), 'FitxadminController@fitxadmin')) paginaActual barra-baja @else lletraNav-transition @endif"
                        href="{{ route('fitxadmin') }}">Fitxatge</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link @if (strpos(Route::currentRouteAction(), 'AfegirController@afegir')) paginaActual barra-baja @else lletraNav-transition @endif"
                        href="{{ route('afegir') }}">Afegir</a>
                </li>
                {{-- <li class="nav-item">
